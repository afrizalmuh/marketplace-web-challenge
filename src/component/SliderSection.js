...
const SliderSection = () => {
  ...
  const settings = {
    ...
    //   return (
    //     <a className='w-44 h-20'>
    //       <img src={`${imgPath}/thumbnail/thumbnail-${i + 1}.png`} alt={i} className='w-full h-full object-cover' />
    //     </a>
    //   );
    // },
    dots: true,
  ...
  return (
    <>
      <Slider {...settings} className="font-spacegrotesk overflow-hidden">
        <div className='relative'>
          <div className='absolute text-[48px] text-[#EBCC24] pt-[50px] pl-[20rem]'>
        ...
        <div className='relative'>
          <div className='absolute text-[#EBCC24]  pt-[82px] pl-[20rem]'>
        ...
        <div className='relative'>
          <div className='absolute text-blue-1 pt-[82px] pl-[20rem]'>
            <div className='text-[64px] flex flex-col'>New
              <span className='text-[#EBCC24] font-bold'> Children’s Books </span>
        ...
        <div className='relative'>
          <div className='absolute text-2xl text-blue-1  pt-[50px] pl-[20rem] font-semibold'>
        ...
        <div className='relative'>
          <div className='absolute text-[#EBCC24] pt-[105px] pl-[20rem]'>
